  ...
  return (
    <main className="min-h-screen px-5 py-14" style={{ color: 'var(--text)' }}>
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-lg max-w-3xl leading-relaxed mb-9" style={{ color: 'var(--text-muted)' }}>GroundTruth exposes an asynchronous API and MCP server for creating funded field missions, tracking human execution, and retrieving verified evidence.</p>
